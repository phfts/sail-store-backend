...
ActiveRecord::Schema[8.0].define(version: 2025_08_26_203955) do
  ...
  create_table "order_items", force: :cascade do |t|
    ...
    t.index ["store_id", "external_id"], name: "index_order_items_on_store_id_and_external_id_unique", unique: true, where: "(external_id IS NOT NULL)"
  ...
  create_table "returns", force: :cascade do |t|
    ...
    t.bigint "seller_id"
    t.bigint "store_id"
    t.decimal "return_value", precision: 10, scale: 2, default: "0.0"
